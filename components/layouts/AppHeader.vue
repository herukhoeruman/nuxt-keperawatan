            ...
            <div class="dropdown-menu dropdown-menu-end p-3 mega-dropdown">
              <div class="row">
                ...
                <div class="col-md-3">
                  ...
                  <div class="list-group list-group-borderless">
                    <div
                      class="list-group-item d-flex align-items-center border-bottom"
                    >
                      <div class="flex-shrink-0 me-2">
                    ...
                    <small class="list-group-item">
                      ...
                      Hic dolore unde autem, molestiae eum laborum aliquid at
                      commodi cum? Blanditiis.
                    </small>
                  </div>
                </div>
                <div class="col-md-3">
              ...
              <div class="d-flex align-items-center border-bottom px-3 py-2">
                ...
                <div class="flex-grow-1 ms-3">
                  ...
                  <span class="text-muted fst-italic"
                    ><a
                      href="https://themeon.net/cdn-cgi/l/email-protection"
                      class="__cf_email__"
                      data-cfemail="325353405d5c6d515a5344574872574a535f425e571c515d5f"
                      >[email&#160;protected]</a
                    ></span
                  >
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-5">
                  ...
                  <div class="list-group list-group-borderless h-100 py-3">
                    ...
                    >
                      <span
                        ><i class="demo-pli-mail fs-5 me-2"></i> Messages</span
                      >
                    ...
                    >
                      <i class="demo-pli-computer-secure fs-5 me-2"></i> Lock
                      screen
                    </a>
                    <a href="#" class="list-group-item list-group-item-action">
