  ...
  <div>
    <div class="content__header content__boxed overlapping">
      <div class="content__wrap">
        ...
        <h1 class="page-title mb-3 mt-2">Pengkajian Keperawatan Keluarga</h1>
      </div>
    </div>
      ...
      <div class="content__wrap">
        <div class="card mb-3">
          <div class="card-body">
            ...
            <form class="row">
              <div class="col-6">
                <label for="_dm-staticEmail" class="visually-hidden"
                  >Cari data</label
                >
                <select class="form-select" aria-label="Default select example">
                  <option selected>Cari data</option>
        ...
        <div class="card">
          <div class="card-header -4 mb-3">
            <h5 class="card-title mb-3">Data Keperawatan Keluarga</h5>
            <div class="row">
              <!-- Left toolbar -->
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <span class="text-muted"
                        ><i class="demo-pli-clock"></i> Oct 22, 2021</span
                      >
                    </td>
                    <td>$45.00</td>
                    <td class="fs-5">
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="text-muted"
                        ><i class="demo-pli-clock"></i> Oct 24, 2021</span
                      >
                    </td>
                    <td>$245.30</td>
                    <td class="fs-5">
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="text-muted"
                        ><i class="demo-pli-clock"></i> Oct 15, 2021</span
                      >
                    </td>
                    <td>$77.99</td>
                    <td class="fs-5">
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="text-muted"
                        ><i class="demo-pli-clock"></i> Oct 12, 2021</span
                      >
                    </td>
                    <td>$18.00</td>
                    <td class="fs-5">
